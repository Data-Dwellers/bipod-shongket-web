...
export default function Dashboard() {
  ...
  const handleGetSOS = async () => {
    ...
    try {
      ...
      setReply("An unexpected error occurred while fetching SOS requests");
      setIsLoading(false);
    }
  };
  ...
  const handleDeleteSOS = async (query) => {
    ...
    try {
      ...
      if (result) {
        ...
        setMessage(result.message || "SOS request deleted successfully");
      ...
      setMessage("An unexpected error occurred while deleting SOS request");
      setIsLoading(false);
    }
  };
  ...
  return (
    <>
      ...
      <Separator></Separator>
      <div className="space-y-10 p-10">
        <h1 className="text-5xl font-black">Button to get all the requests</h1>
        <Button
          size="lg"
          className="text-4xl p-10"
